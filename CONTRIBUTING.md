...
* Once released, typical length (<200 lines) and atomic scope standards for changes would be applied with PRs. Length of a single commit would not exceed 400 lines.
